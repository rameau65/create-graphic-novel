...
- Every page/cut has one clear job and changes story state or reader understanding.
- The adaptation preserves the source thesis, causal logic, quotations, and cultural meaning.
- Visual motifs are planted before payoff; the ending echoes or transforms an earlier image.
- Narration does not redundantly describe visible action.
...
- Face, age, hair, body, costume, palette, and style remain stable.
- Character positions, gaze, screen direction, geography, time, and light direction match.
- Props have the correct owner, count, hand, and state.
- Deliberate changes are motivated and visible, not accidental drift.
